  ...
  return (
    <div className="bg-white sticky top-0 z-50  "  >
      ...
      <header className="relative bg-white">
        ...
        <p className="flex h-10 items-center justify-center bg-red-700 px-2 text-sm font-medium text-white sm:px-4 lg:px-6" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
