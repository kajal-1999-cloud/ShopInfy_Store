    ...
    <footer className="text-gray-600 body-font bg-gray-300" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }}>
            <div  className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap md:text-left text-center order-first">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                          <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3" style={{ color: mode === 'dark' ? 'white' : '' }}>CUSTOMER SERVICES</h2>
                           <nav className="list-none mb-10">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            {/* Payment logo ... We accept... card upi  100% return policy */}
            ...
            <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <div className="flex ">
                             <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>ShopInfy</h1>
                        </div>
                    </Link>
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4" style={{ color: mode === 'dark' ? 'white' : '' }}>© 2024 - ShopInfy --
                        <a href="https://github.com/kajal-1999-cloud?tab=repositories" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank" style={{ color: mode === 'dark' ? 'white' : '' }}>www.ShopInfy.com</a>             
                    </p>
